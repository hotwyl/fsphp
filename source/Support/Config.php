 ...
 * PROJECT URLs
 */
//define("CONF_URL_BASE", "https://emetas.3wonline.com");
define("CONF_URL_BASE", "http://localhost:88/php/fsphp");
define("CONF_URL_TEST", "https://emetas.3wonline.com");
//define("CONF_URL_TEST", "localhost:88/php/fsphp");
